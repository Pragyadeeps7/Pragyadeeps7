  ...
  return (
    <section className="py-24" style={{ background: "#FAFAF7" }}>
      <div className="max-w-[760px] mx-auto px-6 text-center">
        <p className="text-[12px] tracking-[0.4em] mb-3" style={{ color: "#B89778" }}>JOIN THE CIRCLE</p>
        <h2 className="font-serif-display text-[32px] md:text-[44px] leading-tight mb-5">A letter from our atelier</h2>
        <p className="text-[15px] font-body mb-10" style={{ color: "#5C5C5C" }}>
